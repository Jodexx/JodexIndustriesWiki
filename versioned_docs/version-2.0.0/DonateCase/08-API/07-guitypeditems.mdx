...
Користувацькі предмети в гюї оброблюються за допомогою інтерфейсів [TypedItemHandler](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItemHandler.html)
та [TypedItemClickHandler](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItemClickHandler.html)
...
[loadOnCase](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItem.TypedItemBuilder.html#loadOnCase(boolean))
у білдері предмета ([TypedItem#builder](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItem.html#builder())),
...
[updateMeta](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItem.TypedItemBuilder.html#updateMeta(boolean)), 
