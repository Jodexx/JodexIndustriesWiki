...
# Реєстрація івентів
Івенти DonateCase реєструються за допомогою [EventBus](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/event/EventBus.html)

## Прослуховувач
Прослуховувач обов'язково повинен реалізовувати інтерфейс [Subscriber](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/event/Subscriber.html)
