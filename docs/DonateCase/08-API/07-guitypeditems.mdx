...
Користувацькі предмети в гюї оброблюються за допомогою інтерфейсів [TypedItemHandler](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItemHandler.java)
та [TypedItemClickHandler](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItemClickHandler.java)
...
[loadOnCase](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItem.TypedItemBuilder.java#loadOnCase(boolean))
у білдері предмета ([TypedItem#builder](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItem.java#builder())),
...
[updateMeta](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItem.TypedItemBuilder.java#updateMeta(boolean)), 
