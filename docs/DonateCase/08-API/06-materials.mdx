...
Користувацькі матеріали оброблюються за допомогою інтерфейсу [MaterialHandler](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/data/material/MaterialHandler.java)
