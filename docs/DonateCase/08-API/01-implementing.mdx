...
## Головний клас
Головний клас це початкова точка вашого аддону і може наслідковувати лише [InternalJavaAddon](https://github.com/Jodexx/DonateCase/tree/main/api/src/main/java/com/jodexindustries/donatecase/api/addon/InternalJavaAddon.java).
