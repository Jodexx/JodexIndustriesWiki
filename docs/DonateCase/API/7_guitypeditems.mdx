...
Користувацькі предмети в гюї оброблюються за допомогою інтерфейсів [TypedItemHandler](https://repo.jodexindustries.xyz/javadoc/releases/com/jodexindustries/donatecase/api/2.1.0.0/raw/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItemHandler.html)
та [TypedItemClickHandler](https://repo.jodexindustries.xyz/javadoc/releases/com/jodexindustries/donatecase/api/2.1.0.0/raw/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItemClickHandler.html)
...
[loadOnCase](https://repo.jodexindustries.xyz/javadoc/releases/com/jodexindustries/donatecase/api/2.1.0.0/raw/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItem.TypedItemBuilder.html#loadOnCase(boolean))
у білдері предмета ([TypedItem#builder](https://repo.jodexindustries.xyz/javadoc/releases/com/jodexindustries/donatecase/api/2.1.0.0/raw/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItem.html#builder())),
...
[updateMeta](https://repo.jodexindustries.xyz/javadoc/releases/com/jodexindustries/donatecase/api/2.1.0.0/raw/com/jodexindustries/donatecase/api/data/casedata/gui/typeditem/TypedItem.TypedItemBuilder.html#updateMeta(boolean)), 
