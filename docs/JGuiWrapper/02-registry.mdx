...
Для того, щоб зареєструвати якийсь з елементів (лоадер чи обробник), спочатку потрібно зробити ідентифікаційний ключ (бібліотека використовує [Adventure Key](https://jd.advntr.dev/key/4.14.0/net/kyori/adventure/key/package-summary.html))
...
Метод `load` викликатиметься кожного разу, коли визвано метод [AdvancedGui#loadData](https://repo.jodex.xyz/javadoc/releases/com/jodexindustries/jguiwrapper/api/1.0.0.7/raw/com/jodexindustries/jguiwrapper/gui/advanced/AdvancedGui.html#loadData(org.bukkit.entity.HumanEntity))
...
Метод `load` викликатиметься кожного разу, коли визвано метод [GuiItemController#loadItemHandler](https://repo.jodex.xyz/javadoc/releases/com/jodexindustries/jguiwrapper/api/1.0.0.7/raw/com/jodexindustries/jguiwrapper/gui/advanced/GuiItemController.html#loadItemHandler(com.jodexindustries.jguiwrapper.api.gui.LoadType))
